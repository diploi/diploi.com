...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      ' Diploi pre-configures new and imported GitHub projects, with a GitHub Action that is generated based on the contents of the `diploi.yaml` file, which adds a CI/CD pipeline that updates development and staging/production deployments that belong to the project.',
  },
  {
    id: 'devops-preview',
    page: 'devops',
    question: 'Can I preview changes before production?',
    answer: 'Yes, Diploi provides live endpoints for all deployments, which allows you to preview your applications.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! You can launch a trial without registration, directly from our homepage, and stay active for 1 hour.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! Connect Cursor, Zed, VS Code, Windsurf, or any SSH-capable IDE directly to your Diploi development environment.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! Next.js is fully supported with all of its features like App Router, Server Actions, API routes, and SSR.',
  },
  {
    id: 'faq-astro-support',
    page: 'faq',
    question: 'Does Diploi support Astro?',
    answer: 'Absolutely. Diploi supports Astro with SSR, static generation, and hybrid rendering.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! Diploi supports Python applications using frameworks like FastAPI, Django, and Flask.',
  },
  {
    id: 'faq-nodejs-support',
    page: 'faq',
    question: 'Does Diploi support Node.js?',
    answer: 'Yes, and in fact, Node.js was one of our first supported frameworks on Diploi.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Your data is stored in AWS datacenters in Ireland, Europe. We are working on multi-region support.',
  },
  {
